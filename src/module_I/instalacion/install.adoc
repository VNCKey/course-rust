...
IMPORTANT: Antes de comenzar, asegúrate de tener una conexión a internet estable, ya que `rustup` descargará los componentes necesarios.
...
TIP: Si no estás seguro de tu arquitectura, probablemente sea *64 bits (x64)*. Puedes verificarlo en: +
kbd:[Win] + kbd:[Pause/Break] → Tipo de sistema.
...
instalacion.pdf     # Versión para imprimir
----
...
* 📖 https://www.rust-lang.org/learn/get-started[Guía oficial de instalación]
* 🔧 https://rust-lang.github.io/rustup/[Documentación de Rustup]
* 💬 https://users.rust-lang.org/[Foro de la comunidad Rust]
* 🦀 https://doc.rust-lang.org/book/[The Rust Programming Language Book]

[quote, Rust Community]
____
¡Bienvenido a Rust! 🦀 +
Ahora estás listo para comenzar tu viaje en uno de los lenguajes más seguros y eficientes del mundo.
____
